...
__all__ = ["IPERDataset", "SeqIPERDataset"]


class IPERDataset(DatasetBase):

    def __init__(self, opt, is_for_train):
        super(IPERDataset, self).__init__(opt, is_for_train)
        self._name = "IPERDataset"
    ...
    def _read_vids_info(self, file_path):
        ...
        with open(file_path, 'r') as reader:
            ...
            for line in tqdm(lines):
                ...
                alphas_path = glob.glob(os.path.join(self._vids_dir, line, "parse", "*_alpha.png"))
                alphas_path.sort()
                ...
                front_file = os.path.join(self._vids_dir, line, "front_path.json")
...
class SeqIPERDataset(IPERDataset):

    def __init__(self, opt, is_for_train):
        super(SeqIPERDataset, self).__init__(opt, is_for_train)
