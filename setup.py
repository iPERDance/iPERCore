...
WINDOWS_PRECOMPILED_TORCH_CUDA_PAIRS = {
    "1.8.1+cu111": {
        "torch": "https://download.pytorch.org/whl/cu111/torch-1.8.1%2Bcu111-cp{PYTHON_VERSION}-cp{PYTHON_ABI_VERSION}-win_amd64.whl",
        "torchvision": "https://download.pytorch.org/whl/cu111/torchvision-0.9.1%2Bcu111-cp{PYTHON_VERSION}-cp{PYTHON_ABI_VERSION}-win_amd64.whl",
        "mmcv-full": "1.2.0",
        "mmcv-dist": f"{MMCV_DIST}/cu111/torch1.8.1/index.html"
    },
    "1.6.0+cu101": {
